...
// const { printJHipsterFuLogo } = require('./fu-generator-base');

let useBlueprints;

module.exports = class JHipsterFuAppGenerator extends BaseBlueprintGenerator {
    constructor(args, opts) {
        ...
        // TODO handle this properly. Currently there is no way to override the base property
        this.options.skipGeneratedFlag = true;
        ...
        useBlueprints = !this.fromBlueprint && this.instantiateBlueprints('fu');
    ...
    _configuring() {
        return {
            setup() {
                ...
                this.jhipsterConfig.jhiPrefix = appDefaultConfig.jhiPrefix;
            },
            fixConfig() {
    ...
    _composing() {
        return {
            composing() {
                this.composeWithJHipster('fu-server', true);
            },
        };
    }
