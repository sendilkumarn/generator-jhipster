...
module.exports = class JHipsterBaseFuGenerator extends JHipsterBaseGenerator {
    /**
    ...
    printJHipsterFuLogo() {
        ...
        this.log(chalk.white('Welcome to JHipster Fu ') + chalk.yellow(`v${packagejs.version}`));
